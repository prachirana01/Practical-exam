# Practical-exam
Q.1 Write a function that finds the sum of the
...
Q.2 Consider a tuple t1=(1,2,5,7,9,2,4,6,8,10). Write a program to perform following operations:
...
Q.3 Write a menu driven program to perform the following functions on strings:
